                                        ...
                                        <table class="table table-list i-table style-1 mb-4 border-0" id="guestTable-all3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="media-bx d-flex py-3  align-items-center">
                                                            <img class="me-3 rounded-circle" src={require('./images/popular-img/pic-1.jpg')} alt="" />
                                                            <div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="media-bx d-flex py-3  align-items-center">
                                                            ...
                                                            <img class="me-3 rounded-circle" src={require('./images/popular-img/pic-2.jpg')} alt="" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="media-bx d-flex py-3  align-items-center">
                                                        <img class="me-3 rounded-circle" src={require('./images/popular-img/pic-3.jpg')} alt="" />
                                                            <div>
                                                    ...
                                                    <td><span class="badge badge-xl  badge-danger light">Canceled</span></td>
                                                    <td>
                                                        <div>
                                                            <a href="javascript:void(0);" class="btn btn-outline-primary">Order Again</a>
                                                        </div>
