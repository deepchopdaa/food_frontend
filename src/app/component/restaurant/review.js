										...
										<div class="row">
											...
											<div class="col-xl-3 col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
                                                        <img src={require('./images/resturent-review/pic-3.jpg')} alt="" />
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
											...
											<div class="col-xl-3  col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
                                                        <img src={require('./images/resturent-review/pic-4.jpg')} alt="" />
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
											...
											<div class="col-xl-3 col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
                                                        <img src={require('./images/resturent-review/pic-5.jpg')} alt="" />
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
											...
											<div class="col-xl-3 col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
                                                        <img src={require('./images/resturent-review/pic-6.jpg')} alt="" />
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
											...
											<div class="col-xl-3  col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
                                                        <img src={require('./images/resturent-review/pic-7.jpg')} alt="" />
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
