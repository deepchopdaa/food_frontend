                                    ...
                                    <nav className="order-tab">
                                        <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                            ...
                                            <button
                                                ...
                                                id="nav-prepared-tab"
                                                data-bs-toggle="tab"
                                                data-bs-target="#nav-prepared"
                                                type="button"
                                                role="tab"
                                                aria-controls="nav-prepared"
                                                aria-selected="false"
                                            >
                                                Prepared
                                            </button>
                                            ...
                                            {Array.from({ length: 5 }, (_, i) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        <h4 className="text-primary-main mb-0">$202.00</h4>
                                                        <a href="#" className="icon-bx">
                                    ...
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between border-bottom flex-wrap">
                                            ...
                                            <div className="orders-img d-flex mb-4">
                                                <img src={require('./images/chat-img/orders-img/pic-1.jpg')} alt="" />
                                                <div>
                                            ...
                                            <img src={require('./images/chat-img/orders-img/pic-1.jpg')} alt="" />
                                                <div>
                                                    <h4 className="font-w600 text-nowrap mb-0">
                                                        <a href="javascript:void(0);">Pepperoni Pizza</a>
                                                    </h4>
                                                    <p className="mb-0">x1</p>
                                                </div>
                                                <h4 className="text-primary-main mb-0 ms-auto">+$5.59</h4>
                                            </div>
                                            <div className="d-flex align-items-center mb-4">
                                            <img src={require('./images/chat-img/orders-img/pic-1.jpg')} alt="" />
                                                <div>
                                                    <h4 className="font-w600 text-nowrap mb-0">
                                                        <a href="javascript:void(0);">Japanese Ramen</a>
                                                    </h4>
                                                    <p className="mb-0">x1</p>
                                                </div>
                                                <h4 className="text-primary-main mb-0 ms-auto">+$5.59</h4>
                                        ...
                                        <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            <h4 className="cate-title text-primary-main">$12.59</h4>
                                        </div>
                                    </div>
                                </div>
                                <div className="text-end">
                                    <a href="javascript:void(0);" className="btn btn-outline-danger me-sm-4 me-2">
                                        Reject Order
                                    </a>
