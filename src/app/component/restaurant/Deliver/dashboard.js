					...
					<div class="col-xl-5">
						<div class="card">
							<div class="card-header border-0 pb-0">
								<h4 class="cate-title">Profile</h4>
							</div>
								...
								<div class="d-profile">
									<div class="d-flex justify-content-between mb-3 mb-sm-0">
										<div class="d-flex">
											...
											<div>
												<h3 class="font-w700">Jordan Nico</h3>
												...
												<p>Join June 2020</p>
												<a href="edit-profile.html" class="btn btn-light btn-sm">Edit Profile</a>
											</div>
										</div>
										<div>
								...
								<div class="card h-auto">
									<div class="card-body p-3">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div>
												<p>Total Time </p>
												<h4 class="mb-0 font-w700">90 Min</h4>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card-body p-3">
										<div class="d-flex  align-items-center justify-content-between">
											<div class="d-flex">
												...
												<div>
													<p class="mb-0">My Points</p>
													<h4 class="cate-title">3456</h4>
												</div>
											</div>
											<div class="d-flex align-items-center">
												<p class="mb-0">See Reward</p>
								...
								<div class="card">
									<div class="card-body">
										<div class="text-center">
											...
											<h4>80%</h4>
											<p class="mb-0">Min. Performance</p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="card h-auto">
							<div class="card-body">
								<div class="d-flex align-items-center justify-content-between flex-wrap mb-4">
									<h3 class="font-w700">Performance Statistic</h3>
									<div class="d-flex align-items-center">
